...
def register_patient():
    ...
    try:
        ...
        receipt = w3.eth.wait_for_transaction_receipt(tx_hash, timeout=120)
        logs = contract.events.PatientAdded().process_receipt(receipt)
        ...
        if logs:
            ...
            return jsonify({"error": "PatientAdded event not found, but transaction sent.", "txHash": tx_hash.hex()}), 500
