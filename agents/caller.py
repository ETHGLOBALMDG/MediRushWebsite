...
async def medcall():
    ...
    response = await send_message(destination=medcall_addr, message=MedicalQuery(history="None", symptoms="fever", diagnosis="flu", solution="None", side_effects="None"), sync=False)
